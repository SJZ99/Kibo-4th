...
public class WayPointsHelper {
    ...
    private static void addWayPoint() {
        ...
        // 3 <-> 7
        wayPoint[3][7].add(new Point(10.71, -7.7 - 0.068, 4.55));
        wayPoint[3][7].add(new Point(10.85, -8.55, 4.85));
        wayPoint[3][7].add(new Point(11, -8.1, 4.48));
